...
window.AIAssistantModal = function AIAssistantModal({ isOpen = true, onClose, activeCurrency = 'INR', currencyRates = {}, onSelectProperty, onNavigate }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-slate-950/85 backdrop-blur-md">
      <div className="bg-slate-900 border-2 border-teal-500/40 rounded-3xl w-full max-w-2xl h-[92vh] sm:h-[620px] flex flex-col shadow-2xl overflow-hidden text-slate-100 animate-fadeIn">

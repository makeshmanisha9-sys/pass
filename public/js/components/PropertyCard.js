// Passage Property Card Component with WhatsApp Integration
...
window.PropertyCard = function PropertyCard({
  ...
  const formattedMonthPrice = window.PassageAPI.formatCurrency(property.pricePerMonth, activeCurrency, currencyRates);
  const formattedNightPrice = window.PassageAPI.formatCurrency(property.pricePerNight || Math.round(property.pricePerMonth / 25), activeCurrency, currencyRates);
  return /*#__PURE__*/React.createElement("div", {
    ...
    onClick: e => {
      e.stopPropagation();
      const msg = `Hi! Check out this verified expat property "${property.title}" in ${property.city} listed on Passage: http://localhost:5000`;
  ...
  }), /*#__PURE__*/React.createElement("span", null, property.neighborhood, ", ", property.city)), /*#__PURE__*/React.createElement("h3", {
  ...
  }), /*#__PURE__*/React.createElement("span", null, property.bedrooms, " Bed")), /*#__PURE__*/React.createElement("span", null, "\u2022"), /*#__PURE__*/React.createElement("span", {
    className: "flex items-center space-x-1"
  }, /*#__PURE__*/React.createElement("i", {
    className: "fa-solid fa-bath text-slate-400"
  }), /*#__PURE__*/React.createElement("span", null, property.bathrooms, " Bath")), /*#__PURE__*/React.createElement("span", null, "\u2022"), /*#__PURE__*/React.createElement("span", {
    className: "flex items-center space-x-1"
  }, /*#__PURE__*/React.createElement("i", {
